...
"use strict";function showMain(){var e=views["activities-new"];$(".main-content").html(e)}var $=require("jquery"),_=require("underscore"),views=require("views"),router=require("../router");router.route("activities/new",function(){showMain(),$(".newactivity-form").on("submit",function(e){e.preventDefault();var i=$("#newAct").val();console.log(i),$.ajax({method:"POST",url:"/api/activities/",data:i}).done(function(e){alert("saved"),console.log(e)})})});

},{"../router":4,"jquery":"jquery","underscore":"underscore","views":"views"}],2:[function(require,module,exports){
"use strict";function showMain(){var e=views.activities;$(".main-content").html(e)}var $=require("jquery"),_=require("underscore"),views=require("views"),router=require("../router");router.route("","activities",function(){showMain()});
