...
gulp.task('serve', shell.task(['python3 stat_tracker/manage.py runserver']));
...
gulp.task('deploy', function() {
  return gulp.src('./stat_tracker/static/**/*').pipe(ghPages());
});
...
gulp.task('scss', function () {
  return gulp.src('./src/css/main.scss')
    ...
    .pipe(gulp.dest('./stat_tracker/static/css'));
});
...
gulp.task('js', function () {
  ...
  return stream
    ...
    .pipe(gulp.dest('./stat_tracker/static/js'));
});
...
gulp.task('html', function () {
  return gulp.src([src.allHtml, '!' + src.allViews])
    .pipe(gulp.dest('./stat_tracker/static'));
});
